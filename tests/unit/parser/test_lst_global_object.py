...
from pcgen.parser import remove_sourceweb_from_lst_global as rmglobal
...
class TestLstGlobalObject(TestCase):
    ...
    def test_remove_sourceweb_from_global_removes_any_sourceweb_global_tags_from_line(self):
        ...
        globals = "SOURCELONG:Ultimate Magic\tSOURCESHORT:UM\tSOURCEWEB:http://paizo.com/pathfinderRPG/v5748btpy8g7s"
        self.assertEqual(rmglobal(globals), "SOURCELONG:Ultimate Magic\tSOURCESHORT:UM")

        globals = "SOURCELONG:Ultimate Magic\tSOURCESHORT:UM\tSOURCEWEB:http://paizo.com/pathfinderRPG/v5748btpy8g7s\tSOURCEDATE:2011-05"
